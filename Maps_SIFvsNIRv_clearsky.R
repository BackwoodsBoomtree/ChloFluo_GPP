...
# km20_month_R2  <- raster("G:/Russell/Projects/ChloFluo/raster_regressions/global_clearsky/SIF743_NIRv/20km/monthly/")
# km20_month_Pv  <- raster("G:/Russell/Projects/ChloFluo/raster_regressions/global_clearsky/SIF743_NIRv/20km/monthly/")
...
hist(km20_8day_R2, col="gray75", breaks=9, ylim=c(0,80000), xlim=c(0.1,1), xaxs="i", yaxs="i", ann=FALSE, axes=FALSE)
...
hist(km20_8day_R2, col="gray75", breaks=9, ylim=c(0,80000), xlim=c(0.1,1), xaxs="i", yaxs="i", ann=FALSE, axes=FALSE, add=T)
box()
...
# par(new=TRUE)
# op <- par(mar = c(2.1,0.25,8,21)) 
# hist(km20_month_R2, col="gray75", breaks=9, ylim=c(0,80000), xlim=c(0.1,1), xaxs="i", yaxs="i", ann=FALSE, axes=FALSE)
# rect(par("usr")[1],par("usr")[3],par("usr")[2],par("usr")[4],col = "white",border = NA)
# med <- round(median(as.vector(km20_month_R2), na.rm = T), 2)
# abline(v=med, col="red")
# axis(3, tck=F, labels=med, at=med, mgp=c(3, 0.1, 0))
# hist(km20_month_R2, col="gray75", breaks=9, ylim=c(0,80000), xlim=c(0.1,1), xaxs="i", yaxs="i", ann=FALSE, axes=FALSE, add=T)
# box()
